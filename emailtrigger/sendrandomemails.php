...
require_once('classes/email_handler.php');
...
// Page URL.
$pageurl = new moodle_url($CFG->wwwroot . "/local/emailtrigger/sendrandomemails.php");
...
$PAGE->requires->js_call_amd('local_emailtrigger/send_random_email', 'init');

$mform = new emailtrigger_uploadcsvuser_form();

$PAGE->set_heading(get_string('userssubmenu', 'local_emailtrigger'));
$PAGE->set_title(get_string('csvuserslist', 'local_emailtrigger'));

$renderable = new \local_emailtrigger\output\sendrandomemail_renderable();
